...
integer :: i,n,l
    ...
    M_sub(2,1)=r1
    M_sub(2,2)=Psi1
    ! Calculating the ILJ potetial
      NR0=9.0d0+(4.0d0*(r0/re)**2)
      rep0=(eps*6.0d0/(NR0-6.0d0))*(re/r0)**NR0
      atr0=(eps*NR0/(NR0-6.0d0))*(re/r0)**6
      Vpot0=rep0-atr0
      Upot0=2.0d0*rmass*Vpot0+(l*(l+1.0d0)/r0**2)
      Gfunc0=k2-Upot0
      Ffunc0=1.0d0+Gfunc0*(dr**2/12.0d0)	   
    NR1=9.0d0+(4.0d0*(r1/re)**2)
    rep1=(eps*6.0d0/(NR1-6.0d0))*(re/r1)**NR1
    atr1=(eps*NR1/(NR1-6.0d0))*(re/r1)**6
    Vpot1=rep1-atr1
    ...
    do i=1,n
     r2=r1+dr	 
     NR2=9.0d0+(4.0d0*(r2/re)**2)
     rep2=(eps*6.0d0/(NR2-6.0d0))*(re/r2)**NR2
     atr2=(eps*NR2/(NR2-6.0d0))*(re/r2)**6
     Vpot2=rep2-atr2
