...
print *,'Finished.'
deallocate(M_L,M_R)
end program BSwave_1D_Morse


subroutine numerov(n,E,Psi0,Psi1,r0,M_sub)
implicit none
real*8 :: ma,mb,r0,Psi0,Psi1,r_end,rmass,k2,E,re,eps,kc,al,ex0
real*8 :: Vpot2,Gfunc2,Ffunc2,Ffunc1,r2,Upot2,Psi2,ex1,ex2
real*8 :: r1,Vpot0,Upot0,Gfunc0,Ffunc0,dr,Vpot1,Upot1,Gfunc1
real*8, dimension(n+2,2) :: M_sub
integer :: i,n,l
    open(10,file='input.txt')
    read(10,*)eps,re,ma,mb,r_end,l,kc
    close(10)
    rmass=ma*mb/(ma+mb)
    k2=2.0d0*rmass*E
    dr=(r_end-r0)/n
    ...
    M_sub(2,2)=Psi1
    al=sqrt(kc/(2*eps))
    ! Calculating the Morse potetial
      ex0=-1*al*(r0-re)
      Vpot0=(eps*(1-exp(ex0))**2)-eps
      Upot0=2.0d0*rmass*Vpot0+(l*(l+1.0d0)/r0**2)
      Gfunc0=k2-Upot0
      Ffunc0=1.0d0+Gfunc0*(dr**2/12.0d0)	   
    ex1=-1*al*(r1-re)
    Vpot1=(eps*(1-exp(ex1))**2)-eps
