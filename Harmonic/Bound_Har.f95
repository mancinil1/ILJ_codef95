...
print *,'Finished.'
deallocate(M_L,M_R)
end program BSwave_1D_Har


subroutine numerov(n,E,Psi0,Psi1,r0,M_sub)
implicit none
real*8 :: ma,mb,r0,Psi0,Psi1,r_end,rmass,k2,E,re,eps,Hcon
...
integer :: i,n,l
    ...
    read(10,*)eps,re,ma,mb,r_end,l,Hcon
    close(10)
    rmass=ma*mb/(ma+mb)
    k2=2.0d0*rmass*E
    dr=(r_end-r0)/n
